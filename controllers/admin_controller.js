...
module.exports.controller = (app, io, socket_list ) => {
    ...
    const msg_brand_added = "Brand added Succesfully.";
    const msg_brand_update = "Brand updated Succesfully.";
    const msg_brand_delete = "Brand deleted Succesfully.";

    const msg_category_added = "Category added Succesfully.";
    const msg_category_update = "Category updated Succesfully.";
    const msg_category_delete = "Category deleted Succesfully.";

    const msg_type_added = "Type added Succesfully.";
    const msg_type_update = "Type updated Succesfully.";
    const msg_type_delete = "Type deleted Succesfully.";
