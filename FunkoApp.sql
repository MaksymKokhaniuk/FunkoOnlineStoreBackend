...
--
-- Host: localhost:8889
-- Generation Time: Jan 27, 2024 at 06:27 PM
...
CREATE TABLE `address_detail` (
  ...
  `is_deafult` int(1) NOT NULL DEFAULT '0',
...
INSERT INTO `user_detail` (`user_id`, `username`, `name`, `email`, `mobile`, `mobile_code`, `password`, `auth_token`, `dervice_token`, `reset_code`, `status`, `created_date`, `modify_date`) VALUES
(1, 'test', '', 'test@gmail.com', '', '', '123456', '25t2sogdETp7vWxnH7qX', '', '0000', 1, '2024-01-27 20:24:12', '2024-01-27 20:24:12');
